...
public sealed class ActualizarVehiculoCommandValidator : AbstractValidator<ActualizarVehiculoCommand>
{
    ...
    public ActualizarVehiculoCommandValidator(ICategoriaVehiculoQueryRepository categoriaRepository)
    {
        ...
        // Nota: Cambios de costo NO afectan contratos ya creados (snapshot en contratos)
        RuleFor(x => x.Costo)
